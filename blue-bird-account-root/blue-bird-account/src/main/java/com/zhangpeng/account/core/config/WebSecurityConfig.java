...
import com.zhangpeng.account.core.controller.intercept.AuthInterceptor;
...
public class WebSecurityConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getSessionInterceptor()).addPathPatterns("/account/**").excludePathPatterns("/static/**");
